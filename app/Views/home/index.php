...
<div class="container-fluid mt-5">
  <div class="card">
    <div class="card-title text-center info-universitas">
      <img class="img-logo-universitas" src="assets/img/logo-universitas-peradaban.png" alt="">
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="1000">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100" src="assets/img/gedung1.jpg" alt="Universitas" srcset="">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="assets/img/gedung2.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="assets/img/pamflet1.jpg" alt="Third slide">
              </div>
            </div>
          </div>
        </div>
...
<div class="container-fluid mt-5">
  <div class="card">
    <div class="card-title text-center info-ti">
      <img class="img-logo-ti" src="assets/img/logo-ti.png" alt="">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="1000">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100" src="assets/img/gedung1.jpg" alt="ti" srcset="">
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="assets/img/gedung2.jpg" alt="Second slide">
              </div>
